...
*/
void paillier_keygen( paillier_pubkey_t** pub,
...
*/
 paillier_ciphertext_t* paillier_enc(paillier_tag* tag, paillier_ciphertext_t* res,
...
//same decrypt function without mod n operation in the end
paillier_plaintext_t* paillier_dec_nomod( paillier_plaintext_t* res,
																		paillier_pubkey_t* pub,
																		paillier_prvkey_t* prv,
